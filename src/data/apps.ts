...
export const apps: Project[] = [
  {
    ...
    desc: {
      ru: "Нативный автопереключатель раскладки для macOS: перехват клавиш через CGEventTap, определение языка словарём (Bloom-фильтр, 714K слов) + N-граммами, замена набранного слова на лету. Подписочная модель: 14-дневный триал, ключи с привязкой к устройству, лицензионный сервер с Ed25519-подписью ответов. 532 автоматических проверки ядра.",
      en: "A native macOS auto-switcher for keyboard layouts: key interception via CGEventTap, language detection with a dictionary (Bloom filter, 714K words) plus n-grams, replacing the typed word on the fly. Subscription model: a 14-day trial, device-locked keys, a license server with Ed25519-signed responses. 532 automated core checks.",
    },
